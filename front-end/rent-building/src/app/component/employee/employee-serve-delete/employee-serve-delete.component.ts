...
@Component({
  selector: 'app-employee-serve-delete',
  templateUrl: './employee-serve-delete.component.html',
  styleUrls: ['./employee-serve-delete.component.css']
})
export class EmployeeServeDeleteComponent implements OnInit {

  public employeeName;
  public employeeId;

  constructor(
    public dialogRef: MatDialogRef<EmployeeServeDeleteComponent>,
